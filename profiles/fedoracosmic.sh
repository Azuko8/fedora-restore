...
# Fedora Cosmic Setup Script
# Removes bloat and installs stuff I need
# For personal use on Fedora 44 (Cosmic)

set -euo pipefail

echo "=========================================="
echo "Fedora Cosmic Setup Script"
echo "=========================================="
echo ""
echo "OS: Fedora 44 (Cosmic)"
echo ""
...
if sudo dnf install -y fish kitty steam git micro obs-studio btrfs-assistant solaar timeshift > /dev/null; then
